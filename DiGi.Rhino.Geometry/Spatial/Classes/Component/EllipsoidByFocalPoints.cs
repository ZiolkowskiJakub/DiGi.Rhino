    ...
    public class EllipsoidByFocalPoints : VariableParameterComponent
    {
        ...
        protected override Param[] Inputs
        {
            get
            {
                List<Param> result =
                [
                    new Param(new GooPoint3DParam() { Name = "FocalPoint_1", NickName = "FocalPoint_1", Description = "First Focal Point", Access = GH_ParamAccess.item }, ParameterVisibility.Binding),
                    new Param(new GooPoint3DParam() { Name = "FocalPoint_2", NickName = "FocalPoint_2", Description = "Second Focal Point", Access = GH_ParamAccess.item }, ParameterVisibility.Binding),
                    ...
                    new Param(new Grasshopper.Kernel.Parameters.Param_Number() { Name = "C", NickName = "C", Description = "C", Access = GH_ParamAccess.item, Optional = true }, ParameterVisibility.Binding),
                ];
