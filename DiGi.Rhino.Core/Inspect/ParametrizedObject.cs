...
namespace DiGi.Rhino.Core
{
    public static partial class Inspect
    {
        ...
        public static IEnumerable Parameters(this IParametrizedObject parametrizedObject)
        {
            ...
            GetValueSettings getValueSettings = new GetValueSettings(true, true);
            SetValueSettings setValueSettings = new SetValueSettings(true, false);

            List<GooParameter> result = new List<GooParameter>();
