...
**DiGi.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Rhino.Core](DiGi.Rhino.Core)** (Path: `DiGi.Rhino\DiGi.Rhino.Core`)
* **[DiGi.Rhino.Geometry](DiGi.Rhino.Geometry)** (Path: `DiGi.Rhino\DiGi.Rhino.Geometry`)
